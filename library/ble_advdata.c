                            ...
                            uint8_t             * p_len)
{
    ...
    uint16_t actual_length = BLE_GAP_ADV_MAX_SIZE - ADV_FLAG_OFFSET;
	...
	rem_adv_data_len = (BLE_GAP_ADV_MAX_SIZE - adv_offset - ADV_FLAG_OFFSET);
...
*/
    ...
    // Pass encoded advertising data to the stack.
